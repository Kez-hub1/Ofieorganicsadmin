...
import { Edit, Trash2, Eye, Package, DollarSign, Calendar, Tag } from "lucide-react";

const AdminProductList = ({ products, onDeleteProduct }) => {
            ...
            <div key={product.id} className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-200">
              ...
              <div className="p-4">
                ...
                {product.ingredients && product.ingredients.length > 0 && (
                  <div className="mb-3">
                    <p className="text-xs font-medium text-gray-700 mb-1">Key Ingredients:</p>
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => alert("View functionality would show detailed product view")}
                  ...
                  <button
                    onClick={() => alert("Edit functionality would open edit form")}
